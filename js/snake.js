    ...
    return function(config) {
            ...
            if ( modeDropdown ) {
                modeDropdown.addEventListener('change', function(evt) {
                    ...
                    var val = evt.target ? parseInt(evt.target.value) : 75;
								...
								if(selectedOption.text.localeCompare("Custom fpt") == 0)
								{
						...
						var customInput = document.getElementById("customFpt");
						if ( customInput ) {
						
							customInput.addEventListener('change', function(evt) {			
								evt = evt || {};
        ...
        */
        me.eatFood = function() {
            ...
            if(selectedOption.text.localeCompare("Rush (110 fpt, speeds up)") == 0)
            {
        ...
        */
        me.handleDeath = function() {
            ...
            snakeSpeed = parseInt(selectedSpeed);
						if(selectedOption.text.localeCompare("Custom fpt") == 0)
            {
                snakeSpeed = parseInt(customInput.value);
            }
